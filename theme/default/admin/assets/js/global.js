...
$(function(){
    ...
    $(".avatarUpload").each(function(){
        ...
        $("#"+idname).uploadify({
            ...
            'swf'               : '/theme/default/admin/assets/plugin/upload/uploadify/uploadify.swf',
            ...
            'onUploadSuccess' : function(file, data, response) {
                ...
                if( msg.status == "success" ){
                    ...
                    $(".uploadify-queue").on("click",".uploadify-queue-item .cancel",function(){
                      $(this).parent().remove();
                      $('.imageshow-'+idname).attr('src','/theme/default/admin/assets/images/trans.png');
                      $(".image-"+idname).val('');
                    });
                } else {
                    alert('上传失败');
    ...
    $(".delimg").click(function(){
      ...
      $(".image-"+delnum).val("");
      $(".imageshow-"+delnum).attr('src','/theme/default/admin/assets/images/trans.png');
      $(this).remove();
    });
